...
public class GameManager : MonoBehaviour
{
    ...
    IEnumerator SuccessGameCrouitine(MemorizedRoot enums, GamePrefab gamePrefab)
    {
        ...
        {
            prefab = Instantiate(concentration);
            EventManager.GamePlayMemorizedButton(MemorizedRoot.MemorizedConcentration, true);
        }
    }
    ...
    public void TapTheColorEndPanelValue()
    {
        ...
        EventManager.GamePlayAddBrain(GameRoot.TapTheColor, so.score);
        EventManager.GamePlayEndGameValue(EndGameValue.EndGameValueTapTheColor,so.score,brainSO.memoryAverage,brainSO.observationAverage);
    }
    ...
    public void SipinningBlockEndPanelValue()
    {
        ...
        EventManager.GamePlayAddBrain(GameRoot.SpinningBlcok, so.score);
        EventManager.GamePlayEndGameValue(EndGameValue.EndGameValueSpinningBlcok, so.score, brainSO.observationAverage, brainSO.decisionAverage);
    }
    ...
    public void FollowTheLeaderEndPanelValue()
    {
        ...
        EventManager.GamePlayAddBrain(GameRoot.FollowTheLeader, so.score);
        EventManager.GamePlayEndGameValue(EndGameValue.EndGameValueFollowTheLeader, so.score, brainSO.memoryAverage, brainSO.speedAverage);
    }
    ...
    public void SimpliCityEndPanelValue()
    {
        ...
        EventManager.GamePlayAddBrain(GameRoot.SimpliCity, so.score);
    ...
    public void ConcentrationEndPanelValue()
    {
        ...
        EventManager.GamePlayAddBrain(GameRoot.Concentration, so.score);
        EventManager.GamePlayEndGameValue(EndGameValue.EndGameValueConcentration, so.score, brainSO.memoryAverage, brainSO.observationAverage);
    }
