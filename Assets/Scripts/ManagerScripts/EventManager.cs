...
using Enums;
    ...
    //TimeUP Image
    public delegate void onGameTimeUp();
    public static event onGameTimeUp GameTimeUp;

    public static void GamePlayTimeUp()
    {
        GameTimeUp?.Invoke();
    }
    ...
    public delegate void onGameAddBrain(GameRoot gameRoot, float value);
    public static event onGameAddBrain GameAddBrain;

    public static void GamePlayAddBrain(GameRoot gameRoot, float value)
    {
        GameAddBrain?.Invoke(gameRoot, value);
    }
